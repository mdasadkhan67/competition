    ...
    return (
        ...
        >
            ...
            <div className={`fixed inset-0 z-40 lg:hidden transition-all duration-300 ${isOpen ? "opacity-100 pointer-events-auto" : "opacity-0 pointer-events-none"}`}>
                ...
                {/* Side Drawer Content */}
                <div 
                    className={`absolute top-0 right-0 h-screen w-80 max-w-[85vw] bg-brand-dark border-l border-brand-mint/10 shadow-2xl p-6 flex flex-col justify-between transition-transform duration-300 ease-out ${
